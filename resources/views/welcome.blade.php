...
<head>
    ...
    <!-- Styles -->
   <!-- Google tag (gtag.js) -->
   <script async src="https://www.googletagmanager.com/gtag/js?id=G-MTQVWV9XM9"></script>
<script>
...
<div class="trustpilot-widget" data-locale="en-US" data-template-id="56278e9abfbbba0bdcd568bc" data-businessunit-id="67b7c875c713494839509c3f" data-style-height="52px" data-style-width="100%">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KRGZCL7"
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/59f43b594854b82732ff85a5/default';
            s1.charset = 'UTF-8';
    ...
    <!-- Start of Adroll Code for Blogger / Blogspot -->

    <script type="text/javascript">
        adroll_adv_id = "M7SHQOIMRVER7IATM6UJVV";
        adroll_pix_id = "RU7L3U7UY5BAPE6SM3RB7Z";
    ...
    <!-- End of Adroll Code for Blogger / Blogspot -->
    ...
    <script>
        ...
        fbq('init', '464964084042399');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=464964084042399&ev=PageView&noscript=1" /></noscript>
    <!-- End Facebook Pixel Code -->
        ...
        'https://connect.facebook.net/en_US/fbevents.js');
        fbq('init', '407343927823317');
        fbq('track', 'PageView');
        </script>
        <noscript>
        <img height="1" width="1"
        src="https://www.facebook.com/tr?id=407343927823317&ev=PageView
        &noscript=1"/>
        </noscript>
        <!-- End Facebook Pixel Code -->

    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-117250045-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
